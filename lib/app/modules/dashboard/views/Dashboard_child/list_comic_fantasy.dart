...
class ListComicFantasy extends GetView<FilterController> {
  const ListComicFantasy({super.key, required this.screenHeight, required this.screenWidth});
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
                ...
                controller.setCategoryFilter("Fantasy");
                Get.to(() => FilterComicView());
              },
              child: TextCustom(
                text: "Truyện tưởng tượng",
...
class ListComicFantasychild extends GetView<DashboardController> {
  @override
  Widget build(BuildContext context) {
    DashBoardBindings().dependencies();
    return Obx(() {
      var listComicAction = controller.listcomicFantasy.value;
