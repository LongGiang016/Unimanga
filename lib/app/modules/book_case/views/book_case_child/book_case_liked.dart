...
class ComicLiked extends GetView<BookCaseController> {
  const ComicLiked({super.key});
    ...
    return firebaseUser == null
        ...
        : Container(
            ...
            child: RefreshIndicator(
              onRefresh: () => controller.fetchComicLiked(firebaseUser.uid),
              child: Container(
                padding: EdgeInsets.only(top: sizefix(10, screenHeight)),
                width: screenWidth,
                color: AppColors.lightWhite,
                child: Obx(() {
                  if (controller.listComicLiked.isEmpty) {
                    ...
                    return GridView.count(
                      ...
                      crossAxisSpacing: 10,
                      mainAxisSpacing: 10,
                      children: List.generate(controller.listComicLiked.length, (index) {
                        return ComicItems(
                          comic: controller.listComicLiked[index], cateList: 0,
                        );
                      }),
                    );
                  }
