...
class ComicSaved extends GetView<BookCaseController> {
    ...
    return firebaseUser == null
        ...
        : Container(
            ...
            child: RefreshIndicator(
              onRefresh: () => controller.fetchComicSaved1(firebaseUser.uid),
              child: Container(
                padding: EdgeInsets.only(top: sizefix(10, screenHeight)),
                width: screenWidth,
                color: AppColors.lightWhite,
                child: Obx(() {
                  if (controller.listComicSaved1.isEmpty) {
                    ...
                    return GridView.count(
                      ...
                      crossAxisSpacing: 10,
                      mainAxisSpacing: 10,
                      children: List.generate(controller.listComicSaved1.length, (index) {
                        return ComicItems(
                          comic: controller.listComicSaved1[index], cateList: 0,
                        );
                      }),
                    );
                  }
