...
class ListComicIsekai extends GetView<FilterController> {
  const ListComicIsekai({super.key, required this.screenHeight, required this.screenWidth});
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
                ...
                controller.setCategoryFilter("Isekai");
                Get.to(() => FilterComicView());
              },
              child: TextCustom(
                text: "Truyện chuyển sinh",
...
class ListComicIsekaichild extends GetView<DashboardController> {
  @override
  Widget build(BuildContext context) {
    DashBoardBindings().dependencies();
    return Obx(() {
      var listComicAction = controller.listcomicIsekai.value;
